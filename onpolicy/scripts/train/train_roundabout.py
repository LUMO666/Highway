...
def parse_args(args, parser):
    parser.add_argument('--scenario_name', type=str,
                        default='roundaboutvd-v0', help="Which scenario to run on")
    ...
    parser.add_argument('--n_attackers', type=int,
                        default=2, help="number of attack vehicles")
...
def main(args):
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.roundabout_runner import RoundaboutRunner as Runner
    else:
        raise NotImplementedError
