...
class IDMVehicle_Replay(ControlledVehicle):
    """
    ...
    # Parameters added to support multiple action
    SPEED_COUNT: int = 3  # []
    ...
    def __init__(self,
        ...
        # Added to support action level control
    ...
    # Added to support multiple action
