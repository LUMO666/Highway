...
class AbstractEnv(gym.Env):
    ...
    def reset(self):
        ...
        info = {
            ...
            "npc_position": [vehicle.position for vehicle in self.npcs_in_bubble],
        }
        return self.observation_type.observe(), info, self.get_available_actions()
    ...
    def step(self, action: Action):
        ...
        return obs, reward, terminal, info, self.get_available_actions()
